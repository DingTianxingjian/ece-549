...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "language": "c++",
        "name": "pybsds.correspond_pixels",
        "sources": [
            "pybsds/correspond_pixels.pyx",
            "src/csa.cc",
            "src/Exception.cc",
            "src/kofn.cc",
            "src/match.cc",
    ...
    "module_name": "pybsds.correspond_pixels"
}
END: Cython Metadata */
...
#define __PYX_HAVE__pybsds__correspond_pixels
#define __PYX_HAVE_API__pybsds__correspond_pixels
/* Early includes */
#include "ios"
#include "new"
#include "stdexcept"
...
/* Module declarations from 'pybsds.correspond_pixels' */
...
static PyObject *__pyx_f_6pybsds_17correspond_pixels__correspond_pixels(__Pyx_memviewslice, __Pyx_memviewslice, double, double, __Pyx_memviewslice, __Pyx_memviewslice); /*proto*/
...
#define __Pyx_MODULE_NAME "pybsds.correspond_pixels"
extern int __pyx_module_is_main_pybsds__correspond_pixels;
int __pyx_module_is_main_pybsds__correspond_pixels = 0;

/* Implementation of 'pybsds.correspond_pixels' */
...
static const char __pyx_k_pybsds_correspond_pixels[] = "pybsds.correspond_pixels";
static const char __pyx_k_Invalid_shape_in_axis_d_d[] = "Invalid shape in axis %d: %d.";
static const char __pyx_k_itemsize_0_for_cython_array[] = "itemsize <= 0 for cython.array";
static const char __pyx_k_outlier_cost_must_be_1_it_is[] = "outlier_cost must be > 1 (it is {})";
static const char __pyx_k_pybsds_correspond_pixels_pyx[] = "pybsds/correspond_pixels.pyx";
...
static PyObject *__pyx_n_s_pybsds_correspond_pixels;
static PyObject *__pyx_kp_s_pybsds_correspond_pixels_pyx;
...
static PyObject *__pyx_pf_6pybsds_17correspond_pixels_correspond_pixels(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_img0, PyObject *__pyx_v_img1, PyObject *__pyx_v_max_dist, PyObject *__pyx_v_outlier_cost); /* proto */
...
/* "pybsds/correspond_pixels.pyx":23
 * 
 * 
...
static PyObject *__pyx_f_6pybsds_17correspond_pixels__correspond_pixels(__Pyx_memviewslice __pyx_v_img0, __Pyx_memviewslice __pyx_v_img1, double __pyx_v_max_dist, double __pyx_v_outlier_cost, __Pyx_memviewslice __pyx_v_out0, __Pyx_memviewslice __pyx_v_out1) {
  int __pyx_v_rows;
  int __pyx_v_cols;
  ...
  /* "pybsds/correspond_pixels.pyx":25
 * cdef _correspond_pixels(double[::1,:] img0, double[::1,:] img1, double max_dist, double outlier_cost,
 *                         double[::1,:] out0, double[::1,:] out1):
 *     cdef int rows = img0.shape[0]             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "pybsds/correspond_pixels.pyx":26
 *                         double[::1,:] out0, double[::1,:] out1):
 *     cdef int rows = img0.shape[0]
 *     cdef int cols = img0.shape[1]             # <<<<<<<<<<<<<<
 *     cdef double idiag = math.sqrt(rows * rows + cols * cols)
 ...
 */
  ...
  /* "pybsds/correspond_pixels.pyx":27
 *     cdef int rows = img0.shape[0]
 *     cdef int cols = img0.shape[1]
 *     cdef double idiag = math.sqrt(rows * rows + cols * cols)             # <<<<<<<<<<<<<<
 *     cdef double oc = outlier_cost * max_dist * idiag
 ...
 */
  ...
  /* "pybsds/correspond_pixels.pyx":28
 *     cdef int cols = img0.shape[1]
 *     cdef double idiag = math.sqrt(rows * rows + cols * cols)
 *     cdef double oc = outlier_cost * max_dist * idiag             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "pybsds/correspond_pixels.pyx":34
 ...
 */
  ...
  /* "pybsds/correspond_pixels.pyx":35
 *     # work well at all...
 *     cdef Matrix i0 = Matrix(rows, cols)
 *     cdef Matrix i1 = Matrix(rows, cols)             # <<<<<<<<<<<<<<
 *     cdef double[::1,:] i0_view = <double[:img0.shape[0]:1,:img0.shape[1]]>i0.data()
 ...
 */
  ...
  /* "pybsds/correspond_pixels.pyx":36
 *     cdef Matrix i0 = Matrix(rows, cols)
 *     cdef Matrix i1 = Matrix(rows, cols)
 *     cdef double[::1,:] i0_view = <double[:img0.shape[0]:1,:img0.shape[1]]>i0.data()             # <<<<<<<<<<<<<<
 *     cdef double[::1,:] i1_view = <double[:img1.shape[0]:1,:img1.shape[1]]>i1.data()
 ...
 */
  ...
  /* "pybsds/correspond_pixels.pyx":37
 *     cdef Matrix i1 = Matrix(rows, cols)
 *     cdef double[::1,:] i0_view = <double[:img0.shape[0]:1,:img0.shape[1]]>i0.data()
 *     cdef double[::1,:] i1_view = <double[:img1.shape[0]:1,:img1.shape[1]]>i1.data()             # <<<<<<<<<<<<<<
 *     i0_view[:,:] = img0[:,:]
 ...
 */
  ...
  /* "pybsds/correspond_pixels.pyx":38
 *     cdef double[::1,:] i0_view = <double[:img0.shape[0]:1,:img0.shape[1]]>i0.data()
 *     cdef double[::1,:] i1_view = <double[:img1.shape[0]:1,:img1.shape[1]]>i1.data()
 *     i0_view[:,:] = img0[:,:]             # <<<<<<<<<<<<<<
 *     i1_view[:,:] = img1[:,:]
 ...
 */
  ...
  /* "pybsds/correspond_pixels.pyx":39
 *     cdef double[::1,:] i1_view = <double[:img1.shape[0]:1,:img1.shape[1]]>i1.data()
 *     i0_view[:,:] = img0[:,:]
 *     i1_view[:,:] = img1[:,:]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "pybsds/correspond_pixels.pyx":45
 * 
 *     # Perform the match
 ...
 */
  ...
  /* "pybsds/correspond_pixels.pyx":48
 * 
 *     # Get views of the output matrices and copy to our output arrays
 ...
 */
  ...
  /* "pybsds/correspond_pixels.pyx":49
 *     # Get views of the output matrices and copy to our output arrays
 *     cdef double[::1,:] o0_view = <double[:out0.shape[0]:1,:out0.shape[1]]>m0.data()
 *     cdef double[::1,:] o1_view = <double[:out1.shape[0]:1,:out1.shape[1]]>m1.data()             # <<<<<<<<<<<<<<
 *     out0[:,:] = o0_view[:,:]
 ...
 */
  ...
  /* "pybsds/correspond_pixels.pyx":50
 *     cdef double[::1,:] o0_view = <double[:out0.shape[0]:1,:out0.shape[1]]>m0.data()
 *     cdef double[::1,:] o1_view = <double[:out1.shape[0]:1,:out1.shape[1]]>m1.data()
 *     out0[:,:] = o0_view[:,:]             # <<<<<<<<<<<<<<
 *     out1[:,:] = o1_view[:,:]
 ...
 */
  ...
  /* "pybsds/correspond_pixels.pyx":51
 *     cdef double[::1,:] o1_view = <double[:out1.shape[0]:1,:out1.shape[1]]>m1.data()
 *     out0[:,:] = o0_view[:,:]
 *     out1[:,:] = o1_view[:,:]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "pybsds/correspond_pixels.pyx":53
 *     out1[:,:] = o1_view[:,:]
 * 
 *     return cost, oc             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_AddTraceback("pybsds.correspond_pixels._correspond_pixels", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
...
/* "pybsds/correspond_pixels.pyx":56
 * 
 * 
...
/* Python wrapper */
static PyObject *__pyx_pw_6pybsds_17correspond_pixels_1correspond_pixels(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_6pybsds_17correspond_pixels_1correspond_pixels = {"correspond_pixels", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_6pybsds_17correspond_pixels_1correspond_pixels, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_6pybsds_17correspond_pixels_1correspond_pixels(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("pybsds.correspond_pixels.correspond_pixels", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_6pybsds_17correspond_pixels_correspond_pixels(__pyx_self, __pyx_v_img0, __pyx_v_img1, __pyx_v_max_dist, __pyx_v_outlier_cost);
...
static PyObject *__pyx_pf_6pybsds_17correspond_pixels_correspond_pixels(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_img0, PyObject *__pyx_v_img1, PyObject *__pyx_v_max_dist, PyObject *__pyx_v_outlier_cost) {
  ...
  /* "pybsds/correspond_pixels.pyx":57
 * 
 * def correspond_pixels(img0, img1, max_dist=0.0075, outlier_cost=100.0):
 *     if img0.shape != img1.shape:             # <<<<<<<<<<<<<<
 *         raise ValueError('img0.shape ({}) and img1.shape({}) do not match'.format(img0.shape, img1.shape))
 ...
 */
  ...
  if (unlikely(__pyx_t_4)) {
    ...
    /* "pybsds/correspond_pixels.pyx":58
 * def correspond_pixels(img0, img1, max_dist=0.0075, outlier_cost=100.0):
 *     if img0.shape != img1.shape:
 *         raise ValueError('img0.shape ({}) and img1.shape({}) do not match'.format(img0.shape, img1.shape))             # <<<<<<<<<<<<<<
 *     if max_dist <= 0.0:
 ...
 */
  ...
  /* "pybsds/correspond_pixels.pyx":59
 *     if img0.shape != img1.shape:
 *         raise ValueError('img0.shape ({}) and img1.shape({}) do not match'.format(img0.shape, img1.shape))
 *     if max_dist <= 0.0:             # <<<<<<<<<<<<<<
 *         raise ValueError('max_dist must be >= 0 (it is {})'.format(max_dist))
 ...
 */
  ...
  if (unlikely(__pyx_t_4)) {
    ...
    /* "pybsds/correspond_pixels.pyx":60
 *         raise ValueError('img0.shape ({}) and img1.shape({}) do not match'.format(img0.shape, img1.shape))
 *     if max_dist <= 0.0:
 *         raise ValueError('max_dist must be >= 0 (it is {})'.format(max_dist))             # <<<<<<<<<<<<<<
 *     if outlier_cost <= 1:
 ...
 */
  ...
  /* "pybsds/correspond_pixels.pyx":61
 *     if max_dist <= 0.0:
 *         raise ValueError('max_dist must be >= 0 (it is {})'.format(max_dist))
 *     if outlier_cost <= 1:             # <<<<<<<<<<<<<<
 *         raise ValueError('outlier_cost must be > 1 (it is {})'.format(max_dist))
 ...
 */
  ...
  if (unlikely(__pyx_t_4)) {
    ...
    /* "pybsds/correspond_pixels.pyx":62
 *         raise ValueError('max_dist must be >= 0 (it is {})'.format(max_dist))
 *     if outlier_cost <= 1:
 *         raise ValueError('outlier_cost must be > 1 (it is {})'.format(max_dist))             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "pybsds/correspond_pixels.pyx":65
 * 
 * 
 ...
 */
  ...
  /* "pybsds/correspond_pixels.pyx":66
 * 
 *     i0 = img0.astype('float64').copy(order='F')
 *     i1 = img1.astype('float64').copy(order='F')             # <<<<<<<<<<<<<<
 *     o0 = np.zeros_like(i0, order='F')
 ...
 */
  ...
  /* "pybsds/correspond_pixels.pyx":67
 *     i0 = img0.astype('float64').copy(order='F')
 *     i1 = img1.astype('float64').copy(order='F')
 *     o0 = np.zeros_like(i0, order='F')             # <<<<<<<<<<<<<<
 *     o1 = np.zeros_like(i1, order='F')
 ...
 */
  ...
  /* "pybsds/correspond_pixels.pyx":68
 *     i1 = img1.astype('float64').copy(order='F')
 *     o0 = np.zeros_like(i0, order='F')
 *     o1 = np.zeros_like(i1, order='F')             # <<<<<<<<<<<<<<
 *     max_dist = float(max_dist)
 ...
 */
  ...
  /* "pybsds/correspond_pixels.pyx":69
 *     o0 = np.zeros_like(i0, order='F')
 *     o1 = np.zeros_like(i1, order='F')
 *     max_dist = float(max_dist)             # <<<<<<<<<<<<<<
 *     outlier_cost = float(outlier_cost)
 ...
 */
  ...
  /* "pybsds/correspond_pixels.pyx":70
 *     o1 = np.zeros_like(i1, order='F')
 *     max_dist = float(max_dist)
 *     outlier_cost = float(outlier_cost)             # <<<<<<<<<<<<<<
 *     cost, oc = _correspond_pixels(i0, i1, max_dist, outlier_cost, o0, o1)
 ...
 */
  ...
  /* "pybsds/correspond_pixels.pyx":71
 *     max_dist = float(max_dist)
 *     outlier_cost = float(outlier_cost)
 *     cost, oc = _correspond_pixels(i0, i1, max_dist, outlier_cost, o0, o1)             # <<<<<<<<<<<<<<
 *     return o0, o1, cost, oc
 */
  ...
  __pyx_t_8 = __pyx_f_6pybsds_17correspond_pixels__correspond_pixels(__pyx_t_9, __pyx_t_10, __pyx_t_11, __pyx_t_12, __pyx_t_13, __pyx_t_14); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 71, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_8);
  __PYX_XDEC_MEMVIEW(&__pyx_t_9, 1);
  __pyx_t_9.memview = NULL;
  __pyx_t_9.data = NULL;
  ...
  /* "pybsds/correspond_pixels.pyx":72
 *     outlier_cost = float(outlier_cost)
 *     cost, oc = _correspond_pixels(i0, i1, max_dist, outlier_cost, o0, o1)
 *     return o0, o1, cost, oc             # <<<<<<<<<<<<<<
 */
 ...
 * 
 */
      __pyx_t_3 = PyNumber_Add(__pyx_v_part, __pyx_kp_b__21); if (unlikely(!__pyx_t_3)) __PYX_ERR(1, 1478, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_3);
      ...
      __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
      __pyx_t_5 = PyNumber_Add(__pyx_t_6, __pyx_kp_b__21); if (unlikely(!__pyx_t_5)) __PYX_ERR(1, 1478, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_5);
      __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_5);
    __pyx_t_6 = PyNumber_Add(__pyx_t_5, __pyx_kp_b__22); if (unlikely(!__pyx_t_6)) __PYX_ERR(1, 1481, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_6);
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
 ...
 *             result = fmt.string
 */
      __pyx_t_6 = PyUnicode_Join(__pyx_kp_u__23, __pyx_v_extents); if (unlikely(!__pyx_t_6)) __PYX_ERR(1, 1486, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_6);
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "pybsds.correspond_pixels.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "pybsds.correspond_pixels.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "pybsds.correspond_pixels.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "pybsds.correspond_pixels._memoryviewslice", /*tp_name*/
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_pybsds_correspond_pixels, __pyx_k_pybsds_correspond_pixels, sizeof(__pyx_k_pybsds_correspond_pixels), 0, 0, 1, 1},
  {&__pyx_kp_s_pybsds_correspond_pixels_pyx, __pyx_k_pybsds_correspond_pixels_pyx, sizeof(__pyx_k_pybsds_correspond_pixels_pyx), 0, 0, 1, 0},
 ...
 */
  ...
  __pyx_codeobj__25 = (PyObject*)__Pyx_PyCode_New(4, 0, 10, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__24, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_pybsds_correspond_pixels_pyx, __pyx_n_s_correspond_pixels, 56, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__25)) __PYX_ERR(0, 56, __pyx_L1_error)
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_pybsds__correspond_pixels) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "pybsds.correspond_pixels")) {
      if (unlikely(PyDict_SetItemString(modules, "pybsds.correspond_pixels", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "pybsds/correspond_pixels.pyx":5
 ...
 */
  ...
  /* "pybsds/correspond_pixels.pyx":6
 * #
 * import math
 * import numpy as np             # <<<<<<<<<<<<<<
 * 
 ...
 *         raise ValueError('img0.shape ({}) and img1.shape({}) do not match'.format(img0.shape, img1.shape))
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_6pybsds_17correspond_pixels_1correspond_pixels, NULL, __pyx_n_s_pybsds_correspond_pixels); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 56, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_correspond_pixels, __pyx_t_1) < 0) __PYX_ERR(0, 56, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "pybsds/correspond_pixels.pyx":1
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init pybsds.correspond_pixels", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init pybsds.correspond_pixels");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
